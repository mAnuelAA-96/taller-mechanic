...
public class ES {
    ...
    public static int leeEntero() {
        ...
        do {
            try {
                ...
                ES.msgln("Error: No es un número decimal válido. ");
            }
    ...
    public static double leeDecimal() {
        ...
        do {
            try {
                ...
                ES.msgln("Error: No es un número decimal válido.\n" +
                "Recuerda: los decimales se escriben con una coma.");
            }
    ...
    public static double leeDecimal(double minimo) {
        double numero = 0;
        boolean leido = false;
        Scanner teclado = null;
        do {
            try {
                ...
                if (numero >= minimo) {
                    ...
                    ES.msgln("Error: Debe ser un número mayor o igual que " + minimo + ". ");
                }
            } catch (Exception e) {
                ES.msgln("Error: No es un número decimal válido.\n" +
                "Recuerda: los decimales se escriben con una coma.");
    ...
    public static double leeDecimal(String mensaje, double minimo) {
        double numero = 0;
        boolean leido = false;
        Scanner teclado = null;
        do {
            ...
            try {
                ...
                if (numero >= minimo) {
                    ...
                    ES.msgln("Error: Debe ser un número decimal mayor o igual que " + minimo + ".");
                }
            } catch (Exception e) {
                ES.msgln("Error: No es un número decimal válido.\n" +
                "Recuerda: los decimales se escriben con una coma.");
